    ...
    public ProfileGiftsContainer(BaseFragment fragment, Context context, int currentAccount, long did, Theme.ResourcesProvider resourcesProvider) {
        ...
        reorder = new ItemTouchHelper(new ItemTouchHelper.Callback() {
            ...
            public boolean onMove(@NonNull RecyclerView recyclerView, @NonNull RecyclerView.ViewHolder viewHolder, @NonNull RecyclerView.ViewHolder target) {
                ...
                if (fragment instanceof IProfileActivity && ((IProfileActivity) fragment).getGiftsView() != null) {
                    ((IProfileActivity) fragment).getGiftsView().update();
                }
                return true;
            }
    ...
    private void setReordering(boolean reordering) {
        ...
        if (reordering) {
            if (fragment instanceof IProfileActivity) {
                ((IProfileActivity) fragment).scrollToSharedMedia(true);
            }
        }
    }
