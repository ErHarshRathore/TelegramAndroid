    ...
    public void didReceivedNotification(int id, int account, Object... args) {
        if (id == NotificationCenter.boostByChannelCreated) {
            ...
            if (isGiveaway) {
                ...
                if (secondFragment instanceof IProfileActivity) {
                ...
                finishFragment();
                if (secondFragment instanceof IProfileActivity || secondFragment instanceof ChatActivity) {
        ...
        listView.setOnItemClickListener((view, position) -> {
            if (view instanceof GiftedUserCell) {
                ...
                if (boost.giveaway && boost.stars > 0) {
                    ...
                    presentFragment(ProfileScreenFeatureConfigs.getProfileActivityOf(cell.getDialogId()));
                }
            }
