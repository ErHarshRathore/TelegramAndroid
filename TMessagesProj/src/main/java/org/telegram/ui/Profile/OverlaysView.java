...
class OverlaysView extends View implements ProfileGalleryView.Callback {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        selectedPosition = parent.avatarsViewPager.getRealPosition();
        ...
        if (count > 1 && count <= 20) {
            if (parent.overlayCountVisible == 0) {
                alpha = 0.0f;
                parent.overlayCountVisible = 3;
            } else if (parent.overlayCountVisible == 1) {
                alpha = 0.0f;
                parent.overlayCountVisible = 2;
            }
            if (parent.overlayCountVisible == 2) {
            ...
            int y = AndroidUtilities.dp(4) + (Build.VERSION.SDK_INT >= 21 && !parent.isInBubbleMode() ? AndroidUtilities.statusBarHeight : 0);
            for (int a = 0; a < count; a++) {
                ...
                if (a == previousSelectedPotision && Math.abs(previousSelectedProgress - 1.0f) > 0.0001f) {
                    ...
                    if (parent.avatarsViewPager.isCurrentItemVideo()) {
                        progress = currentProgress = parent.avatarsViewPager.getCurrentItemProgress();
                        if (progress <= 0 && parent.avatarsViewPager.isLoadingCurrentVideo() || currentLoadingAnimationProgress > 0.0f) {
                ...
                if (a != selectedPosition) {
                    if (parent.overlayCountVisible == 3) {
            ...
            } else if (parent.overlayCountVisible == 3) {
    ...
    public void onPhotosLoaded() {
        parent.updateProfileData(false);
    }
