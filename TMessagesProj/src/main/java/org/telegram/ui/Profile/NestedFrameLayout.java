...
class NestedFrameLayout extends SizeNotifierFrameLayout implements NestedScrollingParent3 {
    ...
    public void onNestedScroll(View target, int dxConsumed, int dyConsumed, int dxUnconsumed, int dyUnconsumed, int type, int[] consumed) {
        Log.i("TagHarsh", "NestedFrameLayout::onNestedScroll1: target=" + target.getClass().getSimpleName() + ", dxConsumed=" + dxConsumed + ", dyConsumed=" + dyConsumed +
                ", dxUnconsumed=" + dxUnconsumed + ", dyUnconsumed=" + dyUnconsumed + ", type=" + type +
                ", consumed=" + Arrays.toString(consumed));
        try {
    ...
    public void onNestedScroll(View target, int dxConsumed, int dyConsumed, int dxUnconsumed, int dyUnconsumed, int type) {
        Log.i("TagHarsh", "NestedFrameLayout::onNestedScroll2: target=" + target.getClass().getSimpleName() + ", dxConsumed=" + dxConsumed + ", dyConsumed=" + dyConsumed +
                ", dxUnconsumed=" + dxUnconsumed + ", dyUnconsumed=" + dyUnconsumed + ", type=" + type);
    }

    @Override
    public boolean onNestedPreFling(View target, float velocityX, float velocityY) {
        Log.i("TagHarsh", "NestedFrameLayout::onNestedPreFling: target=" + target.getClass().getSimpleName() + ", velocityX=" + velocityX + ", velocityY=" + velocityY);
        return super.onNestedPreFling(target, velocityX, velocityY);
    }

    @Override
    public void onNestedPreScroll(View target, int dx, int dy, int[] consumed, int type) {
        Log.i("TagHarsh", "NestedFrameLayout::onNestedPreScroll: target=" + target.getClass().getSimpleName() + ", dx=" + dx + ", dy=" + dy +
                ", consumed=" + Arrays.toString(consumed) + ", type=" + type);
    ...
    public boolean onStartNestedScroll(View child, View target, int axes, int type) {
        Log.i("TagHarsh", "NestedFrameLayout::onStartNestedScroll: child=" + child.getClass().getSimpleName() + ", target=" + target.getClass().getSimpleName() + ", axes=" + axes + ", type=" + type);
        return parent.sharedMediaRow != -1 && axes == ViewCompat.SCROLL_AXIS_VERTICAL;
    }

    @Override
    public void onNestedScrollAccepted(View child, View target, int axes, int type) {
        Log.i("TagHarsh", "NestedFrameLayout::onNestedScrollAccepted: child=" + child.getClass().getSimpleName() + ", target=" + target.getClass().getSimpleName() + ", axes=" + axes + ", type=" + type);
        nestedScrollingParentHelper.onNestedScrollAccepted(child, target, axes);
    }

    @Override
    public void onStopNestedScroll(View target, int type) {
        Log.i("TagHarsh", "NestedFrameLayout::onStopNestedScroll: target=" + target.getClass().getSimpleName() + ", type=" + type);
        nestedScrollingParentHelper.onStopNestedScroll(target);
    }

    @Override
    public void onStopNestedScroll(View child) {
        Log.i("TagHarsh", "NestedFrameLayout::onStopNestedScroll: child=" + child);
    }

    @Override
    protected void drawList(Canvas blurCanvas, boolean top, ArrayList<IViewWithInvalidateCallback> views) {
        Log.i("TagHarsh", "NestedFrameLayout::drawList: blurCanvas=" + blurCanvas + ", top=" + top + ", views=" + views);
